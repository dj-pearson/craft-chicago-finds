          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground mb-6 text-center">
                Browse our marketplace to find amazing handcrafted items from local makers.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {Object.entries(itemsBySeller).map(([sellerId, { seller_name, items: sellerItems }]) => (
              <Card key={sellerId}>
                <CardHeader>
                  <CardTitle className="text-lg">From {seller_name}</CardTitle>
                </CardHeader>
                    ...
                    <div key={item.listing_id} className="flex items-center gap-4 p-4 border rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Input
                          type="number"
                          value={item.quantity}
                          onChange={(e) => updateQuantity(item.listing_id, parseInt(e.target.value) || 1)}
