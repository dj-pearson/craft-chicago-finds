          ...
          <div className="container mx-auto text-center max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="text-lg px-8">
                <Link to="/chicago">
                  Shop Chicago <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                <Link to="/chicago">
                  <CardHeader>
                    <div className="flex items-center gap-3">
                      ...
                      <CardTitle className="group-hover:text-primary transition-colors">Chicago</CardTitle>
                    </div>
                    <CardDescription>
                      200+ active makers • 500+ unique items
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Discover handmade jewelry, home decor, art, and seasonal crafts from Chicago's vibrant maker community.
                    </p>
                  </CardContent>
                </Link>
              </Card>
              ...
              <Card className="opacity-50">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-muted-foreground">Milwaukee</CardTitle>
                  </div>
                  <CardDescription>Coming Soon</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Join the waitlist to be notified when Milwaukee launches.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="opacity-50">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <MapPin className="h-6 w-6 text-muted-foreground" />
                    <CardTitle className="text-muted-foreground">Detroit</CardTitle>
                  </div>
                  <CardDescription>Coming Soon</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Join the waitlist to be notified when Detroit launches.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/chicago" className="hover:text-foreground">Browse Chicago</Link></li>
