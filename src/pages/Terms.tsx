      ...
      <main id="main-content" role="main" className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p>
              Craft Local ("we," "us," "our") operates as a marketplace platform
              connecting independent sellers with buyers.
              <strong>
                {" "}
                We are not the seller of any products listed on our platform.
              </strong>{" "}
              Each seller is an independent business operator responsible for
              their own products, services, pricing, and fulfillment.
            </p>
            <p className="mt-4">
              We do not manufacture, store, ship, or otherwise handle products
              sold through our platform. All transactions are between buyers and
              individual sellers. We merely provide the technology
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p>
              Sellers on Craft Local are independent contractors, not employees,
              partners, or agents of Craft Local. Sellers maintain complete
              control over their business operations, including:
            </p>
            <ul className="mt-2">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p className="uppercase font-bold">
              ...
              AVAILABLE" WITHOUT WARRANTY OF ANY KIND. WE DISCLAIM ALL
            ...
            <p className="mt-4 uppercase font-bold">
              ...
              OR ERROR-FREE. WE DO NOT WARRANT THE QUALITY, SAFETY, LEGALITY, OR
              AUTHENTICITY OF ANY PRODUCTS SOLD BY SELLERS.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p className="uppercase font-bold">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, CRAFT LOCAL SHALL NOT BE
            ...
            <p className="mt-4">
              ...
              these Terms or the Platform shall not exceed the greater of $100
              or the amount of fees paid by you to us in the 12 months prior to
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <ul className="mt-2">
              ...
              <li>
                Honor stated processing and shipping times (FTC Mail Order Rule
                compliance)
              </li>
              <li>
                Comply with all applicable food safety regulations if selling
                food items
              </li>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p>
              You agree to indemnify, defend, and hold harmless Craft Local and
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            <p>
              ...
              property infringement or other equitable relief.
            </p>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <p className="mt-2">
              Payment processing: Handled by Stripe (2.9% + $0.30 per
              transaction)
            </p>
            <p className="mt-2">
              Sellers are responsible for all taxes, including income tax, sales
              tax, and any applicable business taxes. Craft Local will issue
              1099-K forms to sellers meeting IRS thresholds ($20,000 in sales
